...
/**
  *@brief  ST7735 RST pin control
	...
	*@retval None
	*/
#define LCD_RST1  HAL_GPIO_WritePin(LCD_RST_PORT, LCD_RST_PIN,GPIO_PIN_SET);
#define LCD_RST0  HAL_GPIO_WritePin(LCD_RST_PORT, LCD_RST_PIN,GPIO_PIN_RESET);
...
/**
  *@brief  ST7735 DC pin control
	...
	*@retval None
	*/
#define	LCD_DC1	HAL_GPIO_WritePin(LCD_DC_PORT, LCD_DC_PIN,GPIO_PIN_SET)
#define	LCD_DC0 HAL_GPIO_WritePin(LCD_DC_PORT, LCD_DC_PIN,GPIO_PIN_RESET)
...
/**
  *@brief  ST7735 CS pin control
	...
	*@retval None
	*/
#define	LCD_CS1	HAL_GPIO_WritePin(LCD_CS_PORT, LCD_CS_PIN,GPIO_PIN_SET);
#define	LCD_CS0	HAL_GPIO_WritePin(LCD_CS_PORT, LCD_CS_PIN,GPIO_PIN_RESET);
